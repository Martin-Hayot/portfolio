...
const HeroSection = () => {
    ...
    return (
        ...
        >
            <motion.div
                className="absolute w-96 h-96 z-40 bg-gradient-radial from-orange-500/20 via-transparent to-transparent rounded-full opacity-90 blur-3xl pointer-events-none overflow-hidden"
                style={{
