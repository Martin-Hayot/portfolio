...
const HeroSection = () => {
    return (
        <section className="relative h-screen w-full overflow-hidden bg-black text-white flex flex-col items-center justify-center">
            ...
            {/* Main Content */}
            <div className="relative z-10 flex flex-col items-center justify-center px-4 md:px-6 text-center max-w-5xl mx-auto mt-20 md:mt-0">
                {/* Intro Tag */}
                <motion.div
                ...
                >
                    <span className="flex items-center px-3 py-1 mb-16 text-sm font-medium tracking-widest text-orange-400 uppercase border border-orange-500/20 rounded-full bg-orange-500/5 backdrop-blur-md">
                ...
                >
                    ...
                    Based in{" "}
                    <span className="text-white font-medium">Belgium</span>,
                    creating complex applications <br></br>with care and
                    precision.
                </motion.p>
